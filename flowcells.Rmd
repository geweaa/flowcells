...
adiv %>%
  ...
  ggrepel::geom_text_repel(aes(label = gsub(".[1-2]","",age)), color = "black",
                  ...
                  size = 7/.pt) +
  annotate('text', x = 5.9, y = 4, size = 7 / .pt, label = "bold(italic(n)) == 12", parse = TRUE) +
  annotate('text', x = 5.9, y = 3, size = 7 / .pt, label = "bold(italic(n) == 6)", parse = TRUE) +
  annotate('text', x = 5.9, y = 2, size = 7 / .pt, label = "bold(italic(n) == 12)", parse = T) +
  annotate('text', x = 5.9, y = 1, size = 7 / .pt, label = "bold(italic(n) == 6)", parse = T) +
...
```{r export Fig. 5}
ggsave("figures/fig_5.pdf", height = 12, width = 18, units = "cm")
ggsave("figures/fig_5.png", height = 12, width = 18, units = "cm")
```
