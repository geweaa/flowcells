...
cols <- c("Other" = "#a6cee3", "Burkholderiales" = "#1f78b4",
...
ggsave("figures/fig_5.pdf", height = 10, width = 12, units = "cm")
ggsave("figures/fig_5.png", height = 10, width = 12, units = "cm")
```
