...
seqtab %>%
  ...
  geom_label(aes(label = genus, hjust = hjust), 
            color = "black", fontface = "plain", size = 1.5, label.size = 0.1, label.padding = unit(0.10, "lines")) +
  coord_flip() +
...
```{r export Fig. 2}
ggsave("figures/fig_2.pdf", height = 8, width = 16, units = "cm")
ggsave("figures/fig_2.png", height = 8, width = 16, units = "cm")
```
