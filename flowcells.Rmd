...
nmds.scores %>%
  ...
  mutate(age = ifelse(nature == "Planktonic" & age == "before", "Mar 2016", age)) %>%
  mutate(age = ifelse(nature == "Planktonic" & age == "after", "Apr 2017", age)) %>%
  # Plot
...
cols <- c("Unidentified" = "#f0f0f0",
          ...
          "Clostridiales" = "#ff7f00", # Firmicutes
...
seqcpm %>%
  ...
  ggplot(aes(x = fct_relevel(sample, c('P10152_S1','P10152_S4','P4056_101','P4056_102',
             ...
             fill = fct_relevel(topphylum, c('Unidentified','Other',
                                             ...
                                             "Desulfobacterales",
                                             "Campylobacterales",
                                             "Acholeplasmatales","Clostridiales"))
             )
         ) +
